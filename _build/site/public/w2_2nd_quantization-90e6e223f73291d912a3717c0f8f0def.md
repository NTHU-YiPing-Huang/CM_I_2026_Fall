...
&=\sqrt{\frac{1}{n_{\alpha_1}!...}\frac{1}{n_{\alpha_1'}!...}}\sum_P\langle \alpha_1|\alpha_{P_1}'\rangle\langle \alpha_2|\alpha_{P_2}'\rangle...\langle \alpha_N|\alpha_{P_N}'\rangle.
$$
...
$$
_A\langle \{\alpha_i\}|\{\alpha_i'\}\rangle_A&=\sqrt{\frac{N!}{n_{\alpha_1}!...}\frac{N!}{n_{\alpha_1'}!...}} (N!)^{-2}\sum_P\sum_Q (\alpha_1...|PQ|\alpha_1'...)\\
&=\sqrt{\frac{N!}{n_{\alpha_1}!...}\frac{N!}{n_{\alpha_1'}!...}} (N!)^{-2}\sum_P\sum_{PQ} (\alpha_1...|PQ|\alpha_1'...)\\
&=\sqrt{\frac{1}{n_{\alpha_1}!...}\frac{1}{n_{\alpha_1'}!...}} \sum_{PQ} (\alpha_1...|PQ|\alpha_1'...)\\
&=\sqrt{\frac{1}{n_{\alpha_1}!...}\frac{1}{n_{\alpha_1'}!...}}\sum_P\langle \alpha_1|\alpha_{P_1}'\rangle\langle \alpha_2|\alpha_{P_2}'\rangle...\langle \alpha_N|\alpha_{P_N}'\rangle.
$$
