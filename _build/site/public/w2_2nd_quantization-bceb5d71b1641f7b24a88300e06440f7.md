...
Let's denote the real space coordinate as $\vec{r}$ and the internal coordinate as $\sigma$. The $x$-representation combines both of them, *i.e.* $|x\equiv(\vec{r},\sigma)$.
