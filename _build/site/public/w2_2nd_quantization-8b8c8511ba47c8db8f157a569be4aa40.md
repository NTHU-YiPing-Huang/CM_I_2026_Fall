...
| Time | Topic | Main Learning Objective |
|---|---|---|
| 0--15 min | Why do we need second quantization? | Identify limitations of first-quantized many-particle wavefunctions |
| 15--35 min | From single-particle states to occupation numbers | Understand Fock states and occupation-number representation |
| 35--60 min | Creation and annihilation operators | Learn operator algebra and physical interpretation |
| 60--80 min | One-body Hamiltonians in second quantization | Translate matrix Hamiltonians into $c_i^\dagger c_j$ language |
| 80--95 min | Conceptual exercise / short break | Consolidate the representation change |
| 95--115 min | Many-body interactions | Understand why second quantization becomes especially useful for interacting systems |
| 115--135 min | Collective excitations | Understand that natural excitations need not be bare microscopic particles |
| 135--150 min | Minimal example: phonons | See explicitly how a collective excitation becomes a bosonic quasiparticle |

A useful balance is approximately

$$
\boxed{
\frac{2}{3}\text{ second quantization}
+
\frac{1}{3}\text{ collective excitations}.
}
$$

---

# 2. Why Do We Need Second Quantization?
