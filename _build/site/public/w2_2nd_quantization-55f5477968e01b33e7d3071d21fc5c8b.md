...
Notice that $|0\rangle$ is not zero, it is a specific state with structure. However, in simple cases, the structure is kind of trivial--tensor product of ground state of the single particle Hamiltonian. 
