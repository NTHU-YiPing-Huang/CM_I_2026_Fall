...
&=\sqrt{\frac{1}{n_{\alpha_1}!...}\frac{1}{n_{\alpha_1'}!...}}\underbrace{\sum_P\langle \alpha_1|\alpha_{P_1}'\rangle\langle \alpha_2|\alpha_{P_2}'\rangle...\langle \alpha_N|\alpha_{P_N}'\rangle}_{permenant}.
$$
...
&=\sum_{PQ} (-1)^{PQ} (\alpha_1...|PQ|\alpha_1'...)\\
&=.
$$
