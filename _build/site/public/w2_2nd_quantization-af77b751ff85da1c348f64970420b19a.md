...
With the occupation number notion in mind, we know the counting problem better. For a fictitious state $|\alpha_1\alpha_2...\alpha_N)$ equivalent to $|n_{a_1}n_{a_2}...\rangle$ with $\sum_j n_{a_j}=N$, the distict fictitious state after 
