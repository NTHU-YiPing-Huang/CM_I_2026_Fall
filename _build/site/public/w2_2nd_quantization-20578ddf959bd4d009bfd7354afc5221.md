...
$$
1=N_S ^2\sum_P(N!)^{-2}n_{\alpha_1}!n_{\alpha_2}!...=N_S^2(N!)^{-1} n_{\alpha_1}!n_{}
$$

The summation over $P$ contribute another $N!$ factor since the above statement is true for all $P$. This gives $N_S=n_{\alpha_1}!n_{\alpha_2}!...$ and
