...
Now it is time to consider the normalized wavefunction of a symmetric or antisymmetric state. The wave functioㄙ is a projection to the *fictitious* $x$ coordinates, *i.e.*
