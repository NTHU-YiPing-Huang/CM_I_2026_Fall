...
It is usually tidious to write $|\{n_{\alpha_j}\}\rangle_S$ or $|\{n_{\alpha_j}\}\rangle_A$ explicitly. Usually, we wrote $|\{n_{\alpha_j}\}\rangle$ without the explict subscript when the formulation is valid for 
