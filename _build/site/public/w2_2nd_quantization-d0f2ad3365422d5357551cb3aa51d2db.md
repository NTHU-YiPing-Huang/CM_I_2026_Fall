...
The inner product of two symmetric state therefore is

$$
_S\langle \{\alpha_i\}|\{\alpha_i'\}\rangle_S&=\sqrt{\frac{1}{n_{\alpha_1}!...}\frac{1}{n_{\alpha_1'}!...}}\sum_P\sum_Q (\alpha_1...|PQ|)
$$
