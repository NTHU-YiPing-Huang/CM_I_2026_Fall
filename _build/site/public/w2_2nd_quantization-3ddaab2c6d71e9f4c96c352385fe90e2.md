...
Here $N_S$ stands for the normalization of the wave function in order to keep $ _S\langle \alpha_1\alpha_2...\alpha_N|\alpha_1\alpha_2...\alpha_N\rangle_S=1$. To settle the normalization, we need to be aware that the normalization should be inherent from the single particle normalization $\langle
