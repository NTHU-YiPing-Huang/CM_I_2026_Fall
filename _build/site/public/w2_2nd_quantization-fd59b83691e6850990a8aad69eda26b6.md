...
:::{note} [Excercise] Fill the needed steps to identify the expression $N_S$.
:class: dropdown
...
:::{note} [Excercise] Fill the needed steps to identify the above expression.
:class: dropdown
...
```{exercise} Fill the needed steps to identify the above expression.
```


:::{note} [Exercise] Fill the needed steps to identify the above expression.
:class: dropdown
...
```{exercise} Consider the single-particle Hamiltonian
