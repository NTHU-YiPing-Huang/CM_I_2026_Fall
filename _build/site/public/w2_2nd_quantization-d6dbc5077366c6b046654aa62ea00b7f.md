...
Here, we assume the compelteness relation in $\mathcal{H}_1$ as $\sum_{\alpha}|\alpha\rangle\langle\alpha|=\textbf{1}_{\mathcal{H}_1}$.

To generate wave functions for **indistinguishable** particles, we consider the symmetrization and anti-symmetrize operators
