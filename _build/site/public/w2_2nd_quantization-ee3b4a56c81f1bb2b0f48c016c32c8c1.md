...
Now it is time to consider the normalized wavefunction of a symmetric or antisymmetric state. The wave functio is a projection to the *fictitious* $x$ coordinates, *i.e.*

For antisymmetric case, it is the famous *Slater determin
$$
