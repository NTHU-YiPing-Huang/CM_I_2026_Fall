...
$(\alpha_1\alpha_2...\alpha_N|P=(\alpha_{P_1}\alpha_{P_2}...\alpha_{P_N}|$ is just one of the permutation of $\{\alpha_i\}$. Similarly $Q|\alpha_1\alpha_2...\alpha_N)=|\alpha_{Q_1}\alpha_{Q_2}...\alpha_{Q_N})$. The inner product is identity only when the corresponding permutation $P$ and $Q$ are identicle. For each $P$, the number of such non-zero terms we got while summing over $Q$ is $\frac{N!}{n_{\alpha_1}!n_{\alpha_2}!...}$. After we perform the summation over $Q$, we have

$$
1=N_S ^2\sum_P(N!)^{-2}\frac{N!}{n_{\alpha_1}!n_{\alpha_2}!...}=N_S^2\frac{1}{(n_{\alpha_1}!n_{\alpha_2}!...)^2}
$$

The summation over $P$ contribute another identical factor. This gives $N_S=n_{\alpha_1}!n_{\alpha_2}!...$ and

$$
|\alpha_1\alpha_2...\alpha_N\rangle_S&=\sqrt{n_{\alpha_1}!n_{\alpha_2}!...}S|\alpha_1\alpha_2...\alpha_N)\\
&=\frac{\sqrt{n_{\alpha_1}!n_{\alpha_2}!...}}{N!}\sum_P P|\alpha_1\alpha_2...\alpha_N)
$$
